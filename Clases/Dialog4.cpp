DIALOG Dialog::dialog[] =
{
   ...
   { d_box_proc,             92,  336, 128, 112, 16,  164, 0,    0,      0,   0,   NULL,                                    NULL, NULL },
   { d_text_proc,            100, 380, 82,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("andando"),           NULL, NULL },
   { d_text_proc,            12,  420, 40,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("Anterior:"),         NULL, NULL },
   { d_text_proc,            104, 420, 82,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("disparando"),        NULL, NULL },
   { d_text_proc,            12,  432, 40,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("Siguiente:"),        NULL, NULL },
   { d_text_proc,            104, 432, 82,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("saltando"),          NULL, NULL },
   { d_text_proc,            8,   368, 40,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("Posicion:"),         NULL, NULL },
   { d_text_proc,            100, 368, 82,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("00X, 00Y"),          NULL, NULL },
   ...
   { d_check_proc,           348, 436, 112, 12,  0,   0,   0,    0,      1,   0,   const_cast<char *>("Centrar en pantalla"), NULL, NULL },
   { d_text_proc,            8,   356, 40,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("Posicion:"),         NULL, NULL },
   { d_text_proc,            100, 356, 82,  8,   50,  219, 0,    0,      0,   0,   const_cast<char *>("00X, 00Y"),          NULL, NULL },
