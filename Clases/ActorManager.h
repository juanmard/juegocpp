...
namespace fwg {
    ...
    protected:
        ...
        std::list<Actor*>::iterator actorsIter;     ///< Iterador de la lista de actores.
        std::list<Actor*> toDel;                    ///< Lista de actores a eliminar.
        std::list<Actor*> toCreate;                 ///< Lista de actores a añadir.
    ...
    public:
        ...
        ///
        std::list<Actor*>& getActores (const Bloque& bloque) const;
        ...
        ///         devuelve NULL.
        ///
        Actor* getActor (unsigned int indice) const;
