 ...
 * \brief   Constructor.
 */
ContadorGUI::ContadorGUI (unsigned int &contadorParam):
 ...
 */
int  ContadorGUI::Keyboard (int msg, DIALOG *d, int code)
{
  int salida = D_O_K;
 ...
 */
int  ContadorGUI::Draw (int msg, DIALOG *d, int code)
{
  // Se borra el fondo.
 ...
 */
int  ContadorGUI::Wheel (int msg, DIALOG *d, int code)
{
  int salida = D_O_K;
