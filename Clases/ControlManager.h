...
namespace fwg {
    ...
    class ControlManager
    {
        protected:
            ...
            std::vector<Control*>::iterator controlsIter;           ///< Iterador de la lista de controles.
            std::vector<Peripheral*> peripherals;                   ///< Lista de periféricos a supervisar.
            std::vector<Peripheral*>::iterator peripheralsIter;     ///< Iterador de la lista de periféricos.
            int oldState[MAXPERIPHERALS];                           ///< Lista de antiguos cambios en los periféricos.

        public:
            /// Definición para guardar los distintos cambios en los
            /// componentes de los periféricos y poder configurar los
            /// controles posteriormente mediante un menú.
            ///
            typedef struct
            {
                Peripheral* p;                  ///< Puntero al periférico donde se ha detectado el cambio.
                Peripheral::Component comp;     ///< Componente que ha provocado el cambio.
            } Change;
        ...
        public:
            ...
            /// 
            /// Esto nos permitirá configurar los controles posteriormente
            /// al iniciar el juego.
            /// 
            /// @return Estructura de cambio con la referencia al periférico 
            ///         y el componente.
            ///
            Change getChange ();
            ...
            ///
            int addPeripheral (Peripheral* periph);
            ...
            ///
            Peripheral* getPeripheral (int number);
