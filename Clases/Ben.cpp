...
sentido(1)
{
  ...
  sprites[andando_der]->addFrame(almacen.get_bitmap("ben10_003"), 0, 0, 20);
  sprites[andando_der]->addFrame(almacen.get_bitmap("ben10_004"), 0, 0, 20);
  ...
  sprites[disparando_der]->addFrame(almacen.get_bitmap("ben10_005"),  0, -2, 1);
  sprites[disparando_der]->addFrame(almacen.get_bitmap("ben10_010"),  0, -5, 2);
  sprites[disparando_der]->addFrame(almacen.get_bitmap("ben10_011"),  0, -8, 2);
  sprites[disparando_der]->addFrame(almacen.get_bitmap("ben10_012"),  0, -8, 3);
  sprites[disparando_der]->addFrame(almacen.get_bitmap("ben10_010"),  0, -5, 1);
  sprites[disparando_der]->init ();

  sprites[disparando_izq] = new Sprite(this);
  sprites[disparando_izq]->addFrame(almacen.get_bitmap("ben10_009"),  1, -2, 1);
  sprites[disparando_izq]->addFrame(almacen.get_bitmap("ben10_013"),  1, -5, 2);
  sprites[disparando_izq]->addFrame(almacen.get_bitmap("ben10_014"), 35, -8, 2);
  sprites[disparando_izq]->addFrame(almacen.get_bitmap("ben10_015"), 29, -8, 3);
  sprites[disparando_izq]->addFrame(almacen.get_bitmap("ben10_013"),  1, -5, 1);
  sprites[disparando_izq]->init ();

  sprites[saltando_der] = new Sprite(this);
  sprites[saltando_der]->addFrame(almacen.get_bitmap("ben10_016"),    0, 15, 10);
  sprites[saltando_der]->addFrame(almacen.get_bitmap("ben10_gm_000"), 0, 15,  5);
  sprites[saltando_der]->addFrame(almacen.get_bitmap("ben10_016"),    0, 15,  2);
  sprites[saltando_der]->addFrame(almacen.get_bitmap("ben10_gm_000"), 0, 15,  4);
  sprites[saltando_der]->addFrame(almacen.get_bitmap("ben10_016"),    0, 15,  3);
  sprites[saltando_der]->init ();

  sprites[saltando_izq] = new Sprite(this);
  sprites[saltando_izq]->addFrame(almacen.get_bitmap("ben10_017"), 0, 15, 10);
  sprites[saltando_izq]->init ();

  sprites[bajando_der] = new Sprite(this);
  sprites[bajando_der]->addFrame(almacen.get_bitmap("ben10_018"), 0, -25, 10);
  sprites[bajando_der]->init ();

  sprites[bajando_izq] = new Sprite(this);
  sprites[bajando_izq]->addFrame(almacen.get_bitmap("ben10_019"), 0, -25, 10);
  sprites[bajando_izq]->init ();

  sprites[girando_der] = new Sprite(this);
  sprites[girando_der]->addFrame(almacen.get_bitmap("ben10_001"), 0, 0, 10);
  sprites[girando_der]->addFrame(almacen.get_bitmap("ben10_000"), 0, 0, 10);
  sprites[girando_der]->init ();

  sprites[girando_izq] = new Sprite(this);
  sprites[girando_izq]->addFrame(almacen.get_bitmap("ben10_000"), 0, 0, 10);
  sprites[girando_izq]->addFrame(almacen.get_bitmap("ben10_001"), 0, 0, 10);
